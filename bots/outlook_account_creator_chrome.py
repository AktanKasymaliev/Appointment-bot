...
class OutlookAccountCreatorChrome(AbstractBot):
    ...
    def __generate_random_details():
        ...
        username = OutlookAccountCreatorChrome.__create_username(name)
        password = OutlookAccountCreatorChrome.__generate_password()
    ...
    def __open_browser(use_proxy: bool = False):
        ...
        driver = uc.Chrome(driver_executable_path='/home/aktan/projects/appointment-bot/chromedriver', options=options)
...
if __name__ == '__main__':
    ...
    account_creator = OutlookAccountCreatorChrome(use_proxy=True)
    # Run account creator
